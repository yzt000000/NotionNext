...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wjfan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个打工人', // 作者简介
  //LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yztfwj.cf', // 网站地址
